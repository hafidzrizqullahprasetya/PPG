...
\begin{enumerate}
    \item \textbf{Masuk editor Lvl\_IntroRoom.} Project terbuka langsung pada level \texttt{Lvl\_IntroRoom} yang berisi 407 actors. Panel Outliner menampilkan folder seperti Bridge, Lighting, dan Room\_Animation, sedangkan panel Details dipakai untuk memeriksa properti tiap objek yang diklik.
...
\begin{figure}[H]
    \centering
    \customfbox{\includegraphics[width=0.9\textwidth]{images/ss-26-viewport-ramp.png}}
...
\begin{figure}[H]
    \centering
    \customfbox{\includegraphics[width=0.9\textwidth]{images/ss-07-play-stop.png}}
...
\begin{figure}[H]
    \centering
    \customfbox{\includegraphics[width=0.9\textwidth]{images/ss-08-transform.png}}
...
\begin{figure}[H]
    \centering
    \customfbox{\includegraphics[width=0.9\textwidth]{images/ss-19-sequencer.png}}
...
\begin{figure}[H]
    \centering
    \customfbox{\includegraphics[width=0.9\textwidth]{images/ss-20-sequencer-flythrough.png}}
...
\begin{figure}[H]
    \centering
    \customfbox{\includegraphics[width=0.9\textwidth]{images/ss-12-collision.png}}
...
\begin{figure}[H]
    \centering
    \customfbox{\includegraphics[width=0.9\textwidth]{images/ss-28-material-colorpicker.png}}
...
\begin{figure}[H]
    \centering
    \customfbox{\includegraphics[width=0.9\textwidth]{images/ss-29-material-graph.png}}
...
\begin{figure}[H]
    \centering
    \customfbox{\includegraphics[width=0.9\textwidth]{images/ss-22-niagara.png}}
...
\begin{figure}[H]
    \centering
    \customfbox{\includegraphics[width=0.9\textwidth]{images/ss-17-physics.png}}
...
\begin{figure}[H]
    \centering
    \customfbox{\includegraphics[width=0.9\textwidth]{images/ss-27-hasil-akhir.png}}
...
\begin{figure}[H]
    \centering
    \customfbox{\includegraphics[width=0.9\textwidth]{images/ss-23-animation.png}}
...
\begin{figure}[H]
    \centering
    \customfbox{\includegraphics[width=0.9\textwidth]{images/ss-22-viewport-interior.png}}
...
\begin{figure}[H]
    \centering
    \customfbox{\includegraphics[width=0.9\textwidth]{images/ss-21-blueprint.png}}
...
\begin{figure}[H]
    \centering
    \customfbox{\includegraphics[width=0.9\textwidth]{images/ss-16-metasounds.png}}
...
\begin{thebibliography}{99}
    ...
    \bibitem{wuthering-cover} Kuro Games, ``Wuthering Waves Official Website'', 2026. [Online]. Tersedia: \url{https://wutheringwaves.kurogames.com/en/}.
